				...
				if($lastpage > 1){
						if($this->page){
								...
								if($this->page > 1)
										...
										$this->pagination .= "<span class=\"current\">$p</span>";//LYROS: to ekana current anti disabled
							}
						//pages	
						...
						if($this->page){
								...
								if ($this->page < $counter - 1)
										...
										$this->pagination .= "<span class=\"current\">$n</span>";//LYROS: to ekana current anti disabled
